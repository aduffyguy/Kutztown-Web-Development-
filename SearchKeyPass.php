...
/*	SearchKeyPass.php
	...
	This script reads the data from the products table and seches to find the titles that match the Keyword
*/
...
$dKeyword = $_GET["Kword"];
$query = "SELECT * FROM Products WHERE Title LIKE '%$dKeyword%';";				// define query;
...
{ $Pid = mysql_result($res, $i, "ProductID") ;
  ...
  print "<br>ID: $Pid Title: $PTitle  Author: $PAuthor1  Quantity: $PQuantity Price: $PPrice CategoryID: $PCategoryID <br>" ;
