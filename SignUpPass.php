...
$aPNum = $_GET['PNum'];
//checking if 
$cQuery="SELECT Email FROM Customers WHERE Email = '$aEmail';";
$result =mysql_query($cQuery) or die("Error reading from Bookstore: " . mysql_error( ) );
...
//
mysql_query($query) or die("Error reading from Bookstore: " . mysql_error( ) );
