...
/*	
	...
	This script shows the user the books in teh Catagorie chosen by the user in Browse.php
*/
/*
...
$query = "SELECT * FROM Products WHERE CategoryID = $categoryID;";				// define query;
